...
public class LancamentoResource {
	...
	public ResponseEntity<Lancamento> buscarPeloCodigo(@PathVariable Long codigo) {
		Lancamento lancamentoRetornado = this.lancamentoService.buscarLancamentoPeloCodigo(codigo);
	...
	public ResponseEntity<Object> handlePessoaInexistenteOuInvativaException(PessoaInexistenteOuInvativaException ex) {
